...
import { Building2, Shield, Users, Check } from 'lucide-react'
...
export const SignUp: React.FC<SignUpProps> = ({ 
  ...
  const [view, setView] = useState<'sign_up' | 'magic_link'>('sign_up')
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-xs text-green-700">
                <li className="flex items-center space-x-2">
                  ...
                  <span>AI-powered agent workflows</span>
                </li>
                <li className="flex items-center space-x-2">
                  <Check className="h-3 w-3" />
                ...
                <li className="flex items-center space-x-2">
                  <Check className="h-3 w-3" />
                  <span>Enterprise security & SSO</span>
                </li>
                <li className="flex items-center space-x-2">
                  <Check className="h-3 w-3" />
                  <span>Advanced analytics & KPIs</span>
                </li>
              </ul>
            </div>
          </CardContent>
